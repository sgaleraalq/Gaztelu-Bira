...
/**
 * The label of a pitch slot, already resolved. Callers get a `String` so they never need the
 * resource system this module happens to use.
 */
val LineUpPosition.label: String
