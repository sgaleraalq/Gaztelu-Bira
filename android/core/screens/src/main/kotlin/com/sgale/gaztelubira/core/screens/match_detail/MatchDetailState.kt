...
sealed class MatchDetailState {
    ...
    data class Details(val information: MatchDetailInformation?): MatchDetailState()
    data class Lineup(val lineUp: MatchDetailLineUp?): MatchDetailState()
    data class Stats(val stats: MatchDetailStats?): MatchDetailState()
}
