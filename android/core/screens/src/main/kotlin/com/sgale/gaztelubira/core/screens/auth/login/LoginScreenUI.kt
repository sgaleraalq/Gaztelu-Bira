...
import com.sgale.gaztelubira.core.screens.auth.login.ui.DontHaveAccount
import com.sgale.gaztelubira.core.screens.auth.login.ui.ForgotPassword
import com.sgale.gaztelubira.core.screens.auth.login.ui.GoogleLogin
import com.sgale.gaztelubira.core.screens.auth.login.ui.LoginTextFields
import com.sgale.gaztelubira.core.screens.auth.login.ui.OrSpacer
...
fun LoginCard(
    ...
    val loginTxt = stringResource(R.string.login)
    AuthCard {
        LoginTextFields(
            user = user,
            changeEmail = changeEmail,
