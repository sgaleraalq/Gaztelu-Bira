...
class HomeNavigation(
    ...
    internal companion object {
        @Composable
        internal fun rememberHomeNavigationState(tab: HomeTab): HomeNavigationState {
            ...
            return remember { HomeNavigation(tabState, navController, tab) }
        }

        @Composable
        internal fun HomeNavigationContent(
            homeState: HomeNavigationState,
            mainState: NavigationState
        ) {
            homeState as HomeNavigation
