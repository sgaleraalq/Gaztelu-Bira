...
internal object SeasonPlayerMapper : DatabaseMapper<SeasonPlayer, SeasonPlayerEntity> {
    override fun SeasonPlayer.asEntity() =
        SeasonPlayerEntity(
            seasonId = seasonId,
            playerId = id,
            dorsal = dorsal,
    ...
    override fun SeasonPlayerEntity.asModel() =
        SeasonPlayer(
            seasonId = seasonId,
            id = playerId,
            dorsal = dorsal,
