...
import com.sgale.gaztelubira.core.network.legacy.firebase.response.team.TeamMapper.asModel
import com.sgale.gaztelubira.core.network.legacy.firebase.response.team.TeamResponse
...
internal class FetchTeams @Inject constructor(
    ...
    suspend operator fun invoke(): List<Team> =
        fetchList(INFORMATION, TEAMS, TeamResponse::class.java) { it.asModel() }
}
